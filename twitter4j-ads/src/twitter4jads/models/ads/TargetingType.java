...
public enum TargetingType {
    ...
    CUSTOM_AUDIENCE,
    CUSTOM_AUDIENCES_EXCLUDED(true, CUSTOM_AUDIENCE),
    FLEXIBLE_CUSTOM_AUDIENCE,
    //this is for batch targeting
    CUSTOM_AUDIENCE_EXPANDED,
    LANGUAGE,
    CUSTOM_AUDIENCES_EXPANDED(false, CUSTOM_AUDIENCE_EXPANDED),
    RTB_APP_CATEGORY,
    NETWORK_OPERATOR,
